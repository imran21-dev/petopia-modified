  ...
  return (
    <div className="flex justify-center flex-col items-center pt-3">
      ...
      <div className="flex flex-col text-center md:text-left md:flex-row items-center md:gap-10 gap-3 w-full">
        ...
        <div>
          <h1 className="text-xl md:text-3xl font-medium">
            {isAdmin ? "Welcome to Admin Dashboard " : "Welcome to Dashboard "}
            <span className="font-bold bg-gradient-to-br from-red-600 to-primary text-transparent bg-clip-text">
              {user?.displayName.split(" ")[0]}
            </span>
          </h1>
          <p className="md:text-base text-sm">
            Add and Manage Your Pets and Campaigns with Ease!
          </p>
        </div>
      </div>
      ...
      <Link to="/dashboard/add-pet">
        <Button className="rounded-full bg-gradient-to-br from-red-600 to-primary">
          Get Started
        </Button>
      </Link>
    </div>
