      ...
      <SelectContent>
        ...
        <SelectGroup>
          <SelectLabel>Select a category</SelectLabel>
           {
           isLoading ? <ImSpinner3 className="animate-spin mx-auto my-10"/> : category?.map((category, idx) => <SelectItem value={category.category} key={idx}>{category.category}</SelectItem>)
           }
